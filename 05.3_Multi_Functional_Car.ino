...
void handleControl(unsigned long value) 
{
  // Handle the commands
  switch (value) {
    case 0x57e39867:// Receive the number '+'
      Motor_Move(2000,2000,2000,2000);
      break;
    case 0x57e39866:// Receive the number '+'
      Motor_Move(2000,2000,2000,2000);
      break;
    case 0x57e3cc33:// Receive the number '-'
      Motor_Move(-2000,-2000,-2000,-2000);
      break;
    case 0x57e3cd32:// Receive the number '-'
      Motor_Move(-2000,-2000,-2000,-2000);
      break;
    case 0x57e37887:// Receive the number '|<<'
      Motor_Move(-2000,-2000,2000,2000);
      delay(200);
      Motor_Move(0,0,0,0);
      break;
    case 0x57e37986:// Receive the number '|<<'
      Motor_Move(-2000,-2000,2000,2000);
      delay(200);
      Motor_Move(0,0,0,0);
      break;
    case 0x57e3b54a:// Receive the number '>>|'
      Motor_Move(2000,2000,-2000,-2000);
      delay(200);
      Motor_Move(0,0,0,0);      
      break;
    case 0x57e3b44b:// Receive the number '>>|'
      Motor_Move(2000,2000,-2000,-2000);
      delay(200);
      Motor_Move(0,0,0,0);      
      break;
    case 0x57e354ab:// Receive the number '▶'
      Motor_Move(0,0,0,0);
      break;
    case 0x57e355aa:// Receive the number '▶'
      Motor_Move(0,0,0,0);
      break;
    case 0x57e31ee1:// Receive the number '0'
      servo_1_angle=servo_1_angle+10;
      Servo_1_Angle(servo_1_angle);
      break;
    case 0x57e346b9:// Receive the number '1'
      servo_1_angle=servo_1_angle-10;
      Servo_1_Angle(servo_1_angle);
      break;   
    case 0xFF10EF:// Receive the number '4'
      ...
      Servo_1_Angle(servo_1_angle);
      break; 
    case 0x57e32cd3:// Receive the number 'C'
      servo_2_angle=servo_2_angle+10;
      Servo_2_Angle(servo_2_angle);
      break;      
    case 0x57e332cd:// Receive the number '3'
      servo_2_angle=servo_2_angle-10;
      Servo_2_Angle(servo_2_angle);
      break;
